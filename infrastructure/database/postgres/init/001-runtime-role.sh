...
ALTER DEFAULT PRIVILEGES IN SCHEMA dashboard_core GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO :"runtime_user";
ALTER DEFAULT PRIVILEGES IN SCHEMA dashboard_core GRANT USAGE, SELECT ON SEQUENCES TO :"runtime_user";
SQL
