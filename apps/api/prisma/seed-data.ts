...
export function buildSeedData(options: SeedOptions) {
  return {
    ...
    dataSourceTypes: [
      { id: 'source-type-mariadb', code: 'mariadb', name: 'MariaDB / MySQL', implementation: 'available' },
      { id: 'source-type-postgresql', code: 'postgresql', name: 'PostgreSQL', implementation: 'not_implemented' },
