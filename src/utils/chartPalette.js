...
export const CHART_PALETTES = {
  ...
  "professional-blue": createPreset("professional-blue", {
    label: "Professional Blue",
    group: "core",
    description: "Corporate-ready blue spectrum with crisp analytical contrast.",
    toneLabel: "Professional",
    keywords: ["professional", "blue", "corporate", "saas"],
    colors: ["#1e40af", "#2563eb", "#0284c7", "#0f766e", "#475569", "#7c3aed"],
    barGradient: true,
    areaGradient: true,
  }),
  ...
  "executive-dark": createPreset("executive-dark", {
    label: "Executive Dark",
    group: "dark",
    description: "Executive-grade dark palette tuned for premium BI storytelling.",
    toneLabel: "Executive",
    keywords: ["executive", "dark", "premium", "boardroom"],
    colors: ["#93c5fd", "#38bdf8", "#22c55e", "#f59e0b", "#a78bfa", "#f87171"],
    surfaceMode: "dark",
    tooltipMode: "dark",
    barGradient: true,
    areaGradient: true,
  ...
  "finance-green": createPreset("finance-green", {
    label: "Finance Green",
    group: "enterprise",
    description: "Finance-oriented green and blue palette for growth metrics.",
    toneLabel: "Finance",
    keywords: ["finance", "green", "business", "growth"],
    colors: ["#047857", "#059669", "#0f766e", "#2563eb", "#84cc16", "#64748b"],
    barGradient: true,
    areaGradient: true,
  }),
  "corporate-mix": createPreset("corporate-mix", {
    label: "Corporate Mix",
    group: "enterprise",
    description: "Balanced enterprise mix for executive and operational dashboards.",
    toneLabel: "Corporate",
    keywords: ["corporate", "mix", "enterprise", "report"],
    colors: ["#1d4ed8", "#0f766e", "#6d28d9", "#f59e0b", "#dc2626", "#475569"],
    barGradient: false,
    areaGradient: true,
  }),
  ...
  "sunset-warm": createPreset("sunset-warm", {
    label: "Sunset Warm",
    group: "vibrant",
    description: "Warm amber, coral, and violet blend for narrative dashboards.",
    toneLabel: "Warm",
    keywords: ["sunset", "warm", "amber", "coral"],
    colors: ["#f97316", "#fb7185", "#f59e0b", "#c084fc", "#0ea5e9", "#14b8a6"],
    barGradient: true,
    areaGradient: true,
  }),
  "neon-modern": createPreset("neon-modern", {
    label: "Neon Modern",
    group: "vibrant",
    description: "Neon-inspired modern palette with controlled contrast.",
    toneLabel: "Neon",
    keywords: ["neon", "modern", "bright", "bold"],
    colors: ["#22d3ee", "#06b6d4", "#8b5cf6", "#ec4899", "#84cc16", "#f59e0b"],
    barGradient: true,
    areaGradient: true,
    scatterOpacity: 0.78,
    bubbleOpacity: 0.4,
  ...
  "clean-mono": createPreset("clean-mono", {
    label: "Clean Mono",
    group: "mono",
    description: "Clean monochrome palette for focused analytical reading.",
    toneLabel: "Mono",
    keywords: ["mono", "clean", "minimal", "single hue"],
    colors: createMonochromeScale("#334155", "#cbd5e1"),
    areaGradient: false,
    barGradient: false,
  }),
