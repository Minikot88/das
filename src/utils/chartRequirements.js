...
export const CHART_REQUIREMENTS = {
  ...
  line: chartRequirements("line", [
    ...
    role("ys", { min: 0, max: 5 }),
    role("series"),
  ], ["Line charts support either X + Y + optional series, or X + multiple Y measures."]),
  ...
  "smooth-line": chartRequirements("smooth-line", [
    ...
    role("ys", { min: 0, max: 5 }),
    role("series"),
  ], ["Smooth line supports either X + Y + optional series, or X + multiple Y measures."]),
  "step-line": chartRequirements("step-line", [
    role("x", { required: true }),
    role("y"),
    role("ys", { min: 0, max: 5 }),
    role("series"),
  ], ["Step line supports either X + Y + optional series, or X + multiple Y measures."]),
  area: chartRequirements("area", [
    role("x", { required: true }),
    role("y"),
    role("ys", { min: 0, max: 5 }),
    role("series"),
  ], ["Area charts support either X + Y + optional series, or X + multiple Y measures."]),
  ...
  "stacked-area": chartRequirements("stacked-area", [
    ...
    role("ys", { min: 0, max: 5 }),
    role("series"),
  ], ["Stacked area supports either X + Y + series, or X + multiple Y measures."]),
