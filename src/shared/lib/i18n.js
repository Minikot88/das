...
translations.th = {
  ...
  auth: {
    ...
    demoCredentials: "บัญชีทดลอง",
    fillDemoCredentials: "กรอกบัญชีทดลอง",
    ...
    emailPasswordRequired: "ต้องระบุอีเมลและรหัสผ่าน",
    passwordLength: "รหัสผ่านต้องมีอย่างน้อย 6 ตัวอักษร",
    heroHeadline: "เข้าสู่พื้นที่วิเคราะห์ที่พร้อมใช้งานจริง",
    heroAccent: "สร้างแดชบอร์ดได้เร็วขึ้น",
    heroSubtitle: "",
    registerHeroHeadline: "เริ่มพื้นที่ทำงาน BI ของคุณ",
    registerHeroAccent: "จากข้อมูลสู่การตัดสินใจ",
    registerHeroSubtitle: "",
    features: [
      { title: "แดชบอร์ดพร้อมใช้งาน", desc: "จัดกรอบภาพข้อมูลและสรุปผู้บริหารได้อย่างชัดเจน" },
      { title: "ตัวสร้างกราฟแบบภาพ", desc: "แมปฟิลด์ ดูตัวอย่าง SQL และตั้งค่ากราฟได้ในที่เดียว" },
      { title: "ข้อมูลจากระบบ", desc: "โหลดและบันทึกข้อมูลผ่าน Backend และ PostgreSQL อย่างต่อเนื่อง" },
      { title: "พร้อมแชร์", desc: "เปิดมุมมองอ่านอย่างเดียวเพื่อการรีวิวที่เป็นมืออาชีพ" },
    ],
    steps: [
      { step: "01", title: "สร้างบัญชี", desc: "เริ่มใช้งานพื้นที่ทำงานแบบเร็วและปลอดภัย" },
      { step: "02", title: "เลือกโปรเจกต์", desc: "จัดชีตและแดชบอร์ดตามบริบทงานของคุณ" },
      { step: "03", title: "สร้างกราฟ", desc: "แมปข้อมูล ตั้งค่า และเลือกภาพที่เหมาะสม" },
      { step: "04", title: "แชร์ผลลัพธ์", desc: "เปิดมุมมองอ่านอย่างเดียวเพื่อรีวิวร่วมกัน" },
    ],
  },
  share: {
