import type { Aggregation, ChartSettings, ChartType, DemoThemeId, MappingSlotId, SortMode } from "@modules/dashboards/designer-v2/components/types";

export type { DemoThemeId } from "@modules/dashboards/designer-v2/components/types";
