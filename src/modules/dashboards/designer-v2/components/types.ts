export type {
  ...
  MappingRequirement,
  RegistryAggregation,
} from "@modules/dashboards/designer-v2/components/types/chartTypes";
...
export type ChartConfig = {
  ...
  dashboardId: string;
  chartId: string;
  chartType: import("@modules/dashboards/designer-v2/components/types/chartTypes").ChartType | null;
